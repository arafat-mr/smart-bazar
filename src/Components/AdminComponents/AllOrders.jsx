...
const AllOrders = () => {
  ...
  if (!orders.length) return <p className="text-center text-black">No orders found.</p>;
  ...
  return (
    <div className="p-6 bg-transparent backdrop-blur-2xl shadow-2xl rounded-md max-w-7xl mx-auto">
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full border border-gray-900 text-sm md:text-base">
          <thead>
          ...
          <tbody>
            {orders.map((order) => (
              <tr key={order._id} className="hover:bg-gray-300 text-black border border-gray-900">
